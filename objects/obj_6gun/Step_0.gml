if(con == 1) {
    ...
    if(type == 1) {
        with(cr[0]) sprite_index= spr_6gun_crosshair_heart ;
    }
    con= 2;
    alarm[4]= 6;
}
if(con == 3) {
    ...
    if(type == 1) {
        with(cr[1]) sprite_index= spr_6gun_crosshair_heart ;
    }
    con= 4;
    alarm[4]= 6;
}
if(con == 5) {
    ...
    if(type == 1) {
        with(cr[2]) sprite_index= spr_6gun_crosshair_heart ;
    }
    if(keyboard_check(40)) cr[2].y+= 100;
    if(keyboard_check(38)) cr[2].y-= 100;
    if(keyboard_check(39)) cr[2].x+= 100;
    if(keyboard_check(37)) cr[2].x-= 100;
    con= 6;
    no= 0;
    alarm[4]= 3;
}
