...
if(ucon > 0) {
    ...
    if(ucon == 4) {
        ...
        gen.type= u_gen;
        if(!instance_exists(obj_ultimatarget ))
...
if(!instance_exists(obj_ultimabullet ) && !instance_exists(obj_ultimatarget )) {
    // obj_ultimatarget
...
if(bcon > 0) {
    ...
    if(bcon < 7 && r_al > 0) {
        ...
        draw_sprite_ext(spr_beamcircle , 0, x + 56 + armx, y + 56 + army, 2 * (radi + radi_s) / 40, 2 * (radi + radi_s) / 40, 0, 16777215, r_al);
        draw_circle(x - 58 - armx, y + 56 + army, radi + radi_s, 1);
        draw_circle(x - 58 - armx, y + 56 + army, radi + radi_s - 1, 1);
        draw_sprite_ext(spr_beamcircle , 0, x - 58 - armx, y + 56 + army, 2 * (radi + radi_s) / 40, 2 * (radi + radi_s) / 40, 0, 16777215, r_al);
        draw_set_alpha(1);
    }
    if(bcon == 8) {
        cry= 0;
