...
if(amalgam == 1)
    draw_sprite_ext(spr_amalgam_fridge , floor(anim), x, y, 1, 1, 0, 16777215, alpha);
if(con == 1 && (obj_mainchara.x < 122 || obj_mainchara.x > 220) && global.interact == 0) {
    con= 2;
    caster_pause(global.currentsong);
    global.interact= 1;
    if(obj_mainchara.x < 160) global.facing= 1;
    if(obj_mainchara.x > 200) global.facing= 3;
