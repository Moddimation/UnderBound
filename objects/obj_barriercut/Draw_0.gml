...
draw_set_alpha(1);
draw_sprite_ext(spr_barriercut , 0, -bx + shkx, y + shky, 1, 1, 0, 16777215, 1);
draw_sprite_ext(spr_barriercut , 1, bx + shkx, y + shky, 1, 1, 0, 16777215, 1);
timer++;
...
if(timer == 310 && instance_exists(obj_asriel_overworldanim )) {
