...
if(global.mnfight == 2) {
    if(attacked == 0) {
        ...
        if(mycommand >= 0) global.msg[0]= "* Monster does an action.";
        if(mycommand >= 25) global.msg[0]= "* Monster does an action.";
        if(mycommand >= 50) global.msg[0]= "* Monster does an action.";
        if(mycommand >= 75) global.msg[0]= "* Monster does an action.";
        if(mycommand >= 90) global.msg[0]= "* Smells like a monster.";
...
if(global.myfight == 2 && whatiheard != -1 && global.heard == 0) {
    if(whatiheard == 0) {
        global.msc= 0;
        global.msg[0]= "* MONSTER " + string(global.monsteratk[myself]) + " ATK " + string(global.monsterdef[myself]) + " DEF&* Mistakenly believes its lava&  is a monster./^";
        OBJ_WRITER.halt= 3;
