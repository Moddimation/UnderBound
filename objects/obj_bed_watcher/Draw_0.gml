...
if((keyboard_check_pressed(37) || keyboard_multicheck_pressed(0) || keyboard_multicheck_pressed(1)) && con > 7 && con < 30)
    con= 30;
if(con == 5) {
    depth= 100000;
    limbx= 0;
...
draw_sprite_ext(spr_watchingman , 0, x - 20, y - 15, 1, 1, 0, 16777215, walpha);
