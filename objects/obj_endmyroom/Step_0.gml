...
if(timer == 330) tor.sprite_index= spr_toriel_r ;
if(timer == 390) {
    tor.hspeed= -1;
    tor.image_speed= 0.1;
}
...
if(timer == 560) tor.sprite_index= spr_toriel_r ;
if(timer == 640 && death == 0) {
    caster_play(doorclose, 0.8, 1);
    caster_stop(crickets);
    depth= -9000;
}
if(timer == 760 && death == 0) room_goto(286);
...
if(death == 1 && timer >= 760 && instance_exists(eyeflash) && eyeflash.image_index >= 5) {
