...
if(conversation == 3 && instance_exists(obj_torface ))
    conversation= 3.5;
if(conversation == 3.5 && !instance_exists(obj_torface )) {
    room_persistent= 0;
...
if(conversation == 21 && !instance_exists(OBJ_WRITER ) && flow_m.image_index >= 5) {
    flow_m.visible= 0;
    conversation= 21.2;
    alarm[4]= 50;
}
if(conversation == 22.2 && !instance_exists(OBJ_WRITER )) {
    global.plot= 1;
...
if(conversation == 23) {
    temptor= scr_marker(146, __view_get( e__VW.YView, 0 ) - 60, 1103);
