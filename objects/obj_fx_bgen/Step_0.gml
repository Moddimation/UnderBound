...
if(attack == 3) {
    counter++;
    counter2++;
    if(counter > 20) instance_create(110 + random(400), 200, obj_gigavine_preview );
...
if(attack == 4) {
    counter++;
    counter2++;
    if(counter2 < 90 && counter == 8) instance_create(0, 0, obj_spinbullet_huge_gen_preview );
...
if(attack == 5) {
    ...
    if(counter2 < 100) {
        if(counter == 10) {
            gn= instance_create(100 + random(420), -100, obj_floweynuke );
            gn2= instance_create(100 + random(420), -100, obj_floweynuke );
        }
        if(counter == 12) {
...
if(attack == 6) {
    counter++;
    if(counter == 12) instance_create(random(530), 140, obj_mouthball );
    if(counter == 24) instance_create(random(530), 140, obj_mouthball );
    if(counter == 36) instance_create(random(530), 140, obj_mouthball );
}
if(attack == 7) {
    counter2++;
    counter++;
    if(counter < 100) {
        if(counter == 16) instance_create(0, 200 + random(280), obj_f_handgun );
...
if(attack == 9) {
    ...
    if(counter >= 93 && instance_exists(obj_floweyx_flamethrower ))
...
if(attack == 20) {
    ...
    if(counter2 == 70 && global.my_hp >= nowhp) {
        // obj_flowey_master
