if(pause == 1) {
    siner= 0;
    draw_sprite_ext(spr_glyde_hurt , image_index, x - 72, y - 24, 1, 1, 0, 16777215, 1);
    x= xstart;
    y= ystart;
} else  {
    dsiner++;
    ...
    draw_sprite_ext(spr_glyde_antenna , 0, x + 54 + gg * 2, y + 4, 2, 2, 20 - gg * 20, 16777215, 1);
    if(sh == 1) {
        sh_timer+= sh_speed;
        if(sh_timer > 1) {
            if(sh_timer >= 6)
                draw_sprite_ext(spr_glydeshot , 0, x + 72 + gg * 8, y + gg * 10 - 8, 2, 2, 20 - gg * 20, 16777215, 1);
            if(floor((sh_timer - 1) / 2) < 4)
                draw_sprite_ext(spr_glyde_blackflash_b , floor((sh_timer - 1) / 2), x + 72 + gg * 8, y + gg * 10 - 8, 2, 2, 20 - gg * 20, 16777215, 1);
            if(diff < 1) diff= 1;
            if(sh_timer >= 12) {
                i= 0;
                while(i < diff) {
