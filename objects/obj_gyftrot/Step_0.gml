...
if(global.mnfight == 2 && attacked == 0) {
    ...
    if(mercymod > 90) global.turntimer= -2;
    global.firingrate= 5;
    if(global.hardmode == 1) global.firingrate= 3;
    ...
    if(googly == 1) global.msg[0]= "* Gyftrot stumbles blindly.";
    ...
    if(betray == 1) global.msg[0]= "* Gyftrot looks disappointed.";
...
if(global.myfight == 2 && whatiheard != -1) {
    if(global.heard == 0) {
        if(whatiheard == 0) {
            global.msc= 0;
            global.msg[0]= "* GYFTROT - ATK 16 DEF 8&* Some teens " + chr(ord("\"")) + "decorated" + chr(ord("\"")) + " it as&  a prank./^";
            OBJ_WRITER.halt= 3;
        ...
        if(whatiheard == 1) {
            ...
            if(itemgone < 3) {
                if(gift[itemgone] == 0)
                    global.msg[0]= "* You remove the striped cane&  that says " + chr(ord("\"")) + "I use this tiny&  cane to walk" + chr(ord("\"")) + " on it./^";
                if(gift[itemgone] == 1)
            ...
            if(googly == 1) global.msg[0]= "* You remove the googly eyes./^";
            OBJ_WRITER.halt= 3;
            iii= instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER );
            with(iii) halt= 0;
            if(googly == 1) {
            ...
            if(mercymod < 150) {
                if(itemgone > 0 && mercymod < 100) mercymod= 10;
                if(itemgone > 2) {
                    mercymod= 160;
                    global.flag[138]= 1;
                }
        ...
        if(whatiheard == 3) {
            ...
            if(googly == 0) {
                ...
                mypart5.gift= 8;
            } else  global.msg[0]= "* You can\\'t improve on&  perfection./^";
            OBJ_WRITER.halt= 3;
            iii= instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER );
            with(iii) halt= 0;
        }
