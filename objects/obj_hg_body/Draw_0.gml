...
if(con < 3) {
    draw_sprite_ext(spr_hg_leftovers , 0, x, y + facey / 6, 2, 2, 0, 16777215, image_alpha);
    draw_sprite_ext(spr_hg_horns , 0, x, y - facey / 2, 2, 2, 0, 16777215, image_alpha);
    draw_sprite_ext(spr_hg_mainface , 0, x + 88, y + 72 + facey, 2, 2 + facescale, 0, 16777215, image_alpha);
    draw_sprite_ext(spr_hg_jaws , 0, x + 104, y + 248 - facey / 2, 2, 2, 0, 16777215, image_alpha);
}
if(con == 1.1) {
