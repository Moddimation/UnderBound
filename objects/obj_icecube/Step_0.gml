...
if(global.mnfight == 2 && attacked == 0) {
    if(scr_monstersum() == 1) global.turntimer= 5;
    if(mycommand < 96) {
    ...
    if(mycommand >= 0) global.msg[0]= "* \\'Ice Cap\\' is no more.";
    if(mycommand >= 90)
        global.msg[0]= "* It smells like frozen despair.";
    if(happy == 1) global.msg[0]= "* Ice doesn\\'t mind its identity.";
    if(global.monsterhp[myself] < global.monstermaxhp[myself] / 3)
        global.msg[0]= "* It\\'s melting.";
    attacked= 1;
}
...
if(global.myfight == 2 && whatiheard != -1 && global.heard == 0) {
    if(whatiheard == 0) {
        global.msc= 0;
        global.msg[0]= "* ICE - ATK 1 DEF 0&* Without its cap.../^";
        OBJ_WRITER.halt= 3;
    ...
    if(whatiheard == 3) {
        global.msc= 0;
        global.msg[0]= "* You inform Ice Cap that&  it still looks fine.../^";
        global.flag[137]= 1;
        OBJ_WRITER.halt= 3;
        iii= instance_create(global.idealborder[0], global.idealborder[2], OBJ_WRITER );
        with(iii) halt= 0;
