...
if(movetype == 99) {
    ...
    if(lightning_timer == 125) {
        ...
        repeat(7)  {
            ...
            v= choose(4, 4.5, 5);
            br[i].vspeed= v;
            if(i == fs) br[i].vspeed= 6;
            if(i == fs0) br[i].vspeed= 3;
            i++;
        }
    }
}
...
if(lightning_timer == 110) instance_create(0, 0, obj_legline_l );
if(lightning_timer == 140) instance_create(0, 0, obj_legline_r );
if(lightning_timer == 160) lightning_timer= 20;
life-= 1.25;
