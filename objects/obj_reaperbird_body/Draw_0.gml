...
draw_sprite_ext(spr_reaperbird_torso , floor(torso_index), x + 14 + sx, y + 90 + sy - mstretch * 20, 2, ystretch, 0, 16777215, image_alpha);
if(stretchup == 2) {
...
draw_sprite_ext(headsprite, floor(head_index), x, y, 2, 2 - mstretch, 0, 16777215, image_alpha);
