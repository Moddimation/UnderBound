...
if(shadow_num >= shadow_max) {
    if(level < 3 && !instance_exists(obj_menubone_maker ))
    ...
    if(s_type == 4) {
        ...
        global.idealborder[1]= 520;
        sd= choose(1, -1);
        if(sd == 1) obj_heart.x= global.idealborder[0] + 20;
        else  obj_heart.x= global.idealborder[1] - 20;
        obj_heart.y= global.idealborder[3] - 15;
        global.idealborder[2]= global.idealborder[3] - 110;
    ...
    if(s_type == 8) {
        ...
        global.idealborder[2]= global.idealborder[3] - 110;
        sd= choose(1, -1);
        if(sd == 1) obj_heart.x= global.idealborder[1] - 40;
        else  obj_heart.x= global.idealborder[0] + 40;
        obj_heart.y= global.idealborder[3] - 15;
        i= 0;
        while(i < 10) {
