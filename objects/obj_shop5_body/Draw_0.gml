if(nowemote != global.faceemotion) event_user(0);
...
if(global.faceemotion == 2) {
    ...
    draw_sprite_ext(spr_5_sweat , 0, 133, 39 + sin(siner / 4) * 1.5, 1, 1, 0, 16777215, 1 + sin(siner / 4));
...
if(global.faceemotion == 5) {
    ...
    draw_sprite_ext(spr_5_sweat , 0, 133, 39 + sin(siner / 2) * 2, 1, 1, 0, 16777215, 1 + sin(siner / 2));
    facetimer++;
}
...
if(sellmenu == 1) {
    ...
    if(keyboard_check_pressed(40)) {
        ...
        if(d_fail == 1 && value[sellpos + 1] != 0) d_fail= 2;
...
if(sellmenu == 2) {
    ...
    if(keyboard_check_pressed(13) && buffer <= 0 && sellpos2 == 1)
        sellmenu= 1;
}
