...
with(1411) {
    if(instance_exists(cattywriter) && obj_shopkeeper_catty.face == 0) {
        ...
        else  obj_shopkeeper_catty.banim= 0;
    } else  obj_shopkeeper_catty.banim= 0;
}
...
if(armexp == 0) {
    ...
    if(abs(xx) < 0.1 && abs(yy) < 0.1) armsiner= 0;
...
draw_sprite_ext(spr_catarm , arm, armx2 + xx, army2 + yy, -1, 1, 0, 16777215, 1);
