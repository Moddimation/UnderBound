if(btype[bno] == 0) ggg= instance_create(0, 0, obj_spiderbullet );
if(btype[bno] == 1) ggg= instance_create(0, 0, obj_donutbullet );
if(btype[bno] == 2) ggg= instance_create(0, 0, obj_croissant );
if(btype[bno] < 3) {
    ...
    ggg.dmg= dmg;
    if(instance_exists(obj_spiderb ) && obj_spiderb.turnamt >= 15) {
        with(ggg) dmg--;
    }
}
if(btype[bno] == 3) {
