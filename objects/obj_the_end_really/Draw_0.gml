timer++;
if(type == 0) {
    draw_sprite_ext(spr_undertaletitle , 0, 0, -60, 2, 2, 0, 16777215, 2);
    if(timer == 1) caster_play(noise, 1, 1);
}
if(type == 1) {
    if(photo_alpha <= 1) photo_alpha+= 0.04;
    draw_sprite_ext(spr_friendphoto , 0, 140, 50, 2, 2, 0, 16777215, photo_alpha);
    if(death == 1)
        draw_sprite_ext(spr_charaphoto , 0, 140, 50, 2, 2, 0, 16777215, photo_alpha);
}
if(timer >= 120) {
    draw_set_color(16777215);
    draw_set_font(2);
    if(death == 1) draw_set_color(255);
    if(type == 0) draw_text_transformed(205, 260, string_hash_to_newline("THE END"), 5, 4, 0);
    if(type == 1) draw_text_transformed(205, 300, string_hash_to_newline("THE END"), 5, 4, 0);
}
...
if(timer >= 220 && death == 1) timer= 210;
