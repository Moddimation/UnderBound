x= xstart;
if(sprite_index != 734 && sprite_index != 736 && sprite_index != 742) {
    ...
    if(global.damage > 100 && conversation > 13) sprite_index= spr_torielboss_murdered ;
    if(global.flag[202] >= 20) sprite_index= spr_torielboss_murdered ;
    snd_play(hurtsound);
}
x+= shudder;
...
if(shudder == 0) {
    ...
    alarm[3]= 2;
    if(global.damage > 100) alarm[3]= 3;
    exit;
}
