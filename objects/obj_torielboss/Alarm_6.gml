...
if(global.monsterhp[myself] > 0) {
    if(iwilltalk == 1) {
        ...
        alarm[5]+= 70;
        if(conversation == 1) global.msg[0]= " .....";
        if(conversation == 2) global.msg[0]= " .....& .....";
        if(conversation == 3) global.msg[0]= " .....& .....& .....";
        if(conversation == 4) global.msg[0]= " ...?";
        if(conversation == 5) global.msg[0]= " What are& you& doing?";
        if(conversation == 6) global.msg[0]= " Attack& or run& away!";
        if(conversation == 7)
            global.msg[0]= " What are& you& proving& this way?";
        if(conversation == 8) global.msg[0]= " Fight me& or& leave!";
        if(conversation == 9) global.msg[0]= " Stop it.";
        if(conversation == 10) instance_create(x, y, obj_torgen );
        if(conversation == 10)
            global.msg[0]= " Stop& looking& at me& that way.";
        if(conversation == 11) global.msg[0]= " Go away!";
        if(conversation == 12) global.msg[0]= " ...";
        if(conversation == 12) sprite_index= spr_torielboss_side ;
        if(conversation == 13) global.msg[0]= " ...& ...";
        if(conversation == 13) sprite_index= spr_torielboss_sidesad ;
        if(conversation > 13) {
            alarm[5]+= 400;
            if(conversation == 14) caster_free(global.batmusic);
            global.mercy= 1;
            if(conversation == 14) sprite_index= spr_torielboss_sad ;
            if(conversation == 14)
                global.msg[0]= "I know you want&to go home^1, but...";
            if(conversation > 15) sprite_index= spr_torielboss_sadhappy ;
            if(conversation == 15)
            ...
            if(conversation == 19) sprite_index= spr_torielboss_sad ;
            if(conversation == 19)
                global.msg[0]= "Why are you&making this so&difficult?";
            if(conversation == 20) sprite_index= spr_torielboss_sidesad ;
            if(conversation == 20) global.msg[0]= "Please^1, go upstairs.";
            if(conversation == 21) sprite_index= spr_torielboss_sidesad2 ;
            if(conversation == 21) global.msg[0]= ".....";
            if(conversation == 22) sprite_index= spr_torielboss_sidesadhappy ;
            if(conversation == 22) global.msg[0]= "Ha ha...";
            if(conversation == 23)
                global.msg[0]= "Pathetic^1, is it not^2?&I cannot save even&a single child.";
            if(conversation == 24) global.msg[0]= "...";
            if(conversation == 24) sprite_index= spr_torielboss_sidesad ;
            if(conversation == 25) {
                global.flag[27]= 1;
