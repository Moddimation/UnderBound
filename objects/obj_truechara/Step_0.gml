...
if(con == 4) {
    ...
    global.msg[2]= "My " + chr(ord("\"")) + "human soul." + chr(ord("\"")) + "/";
    global.msg[3]= "My " + chr(ord("\"")) + "determination." + chr(ord("\"")) + "/";
    ...
    global.msg[17]= "" + chr(ord("\"")) + "" + global.charname + "." + chr(ord("\"")) + "/";
    global.msg[18]= "Now./";
    ...
    if(file_exists("system_information_963")) {
        global.msg[0]= "" + chr(ord("\"")) + "" + global.charname + "." + chr(ord("\"")) + "/";
        ...
        global.msg[10]= "" + chr(ord("\"")) + "" + global.charname + "." + chr(ord("\"")) + "/";
        global.msg[11]= ".../";
        global.msg[12]= "But./";
...
if(con == 22 && instance_exists(OBJ_WRITER ) && OBJ_WRITER.stringno == 1)
    sprite_index= spr_truechara_weird ;
if(con == 22 && !instance_exists(OBJ_WRITER )) con= 60;
if(con == 30) {
    global.msc= 0;
    global.typer= 104;
    global.msg[0]= "No...?/";
...
if(con == 31 && instance_exists(OBJ_WRITER ) && OBJ_WRITER.stringno == 4)
    sprite_index= spr_truechara_weird ;
if(con == 31 && !instance_exists(OBJ_WRITER )) con= 40;
if(con == 40) {
    caster_stop(-3);
...
if(con == 42) {
    con= 60;
    if(global.osflavor == 1) window_center();
    flashred= 0;
}
if(con == 60) {
    caster_free(-3);
