...
if(type == 0) {
    ...
    if(oo == 1)
        draw_sprite_ext(spr_toriel_wrapshock , 0, x, y, 2, 2, 0, 16777215, ii);
...
if(type == 1) {
    ...
    if(ss < 0)
        image_blend= make_color_rgb(255, 255 + ss, 255 + ss);
    if(oo == 1)
        draw_sprite_ext(spr_pap_wrapshock , 0, x - 12, y, 2, 2, 0, 16777215, ii);
...
if(type == 2) {
    ...
    if(ss < 0)
        image_blend= make_color_rgb(255, 255 + ss, 255 + ss);
    if(oo == 1)
        draw_sprite_ext(spr_sanswrapshock , 0, x, y, 2, 2, 0, 16777215, ii);
...
if(type == 3) {
    ...
    if(oo == 1)
        draw_sprite_ext(spr_undynewrapshock , 0, x, y, 2, 2, 0, 16777215, ii);
...
if(type == 4) {
    ...
    if(ss < 0)
        image_blend= make_color_rgb(255, 255 + ss, 255 + ss);
    if(oo == 1)
        draw_sprite_ext(spr_alphyswrapshock , 0, x, y, 2, 2, 0, 16777215, ii);
...
if(type == 5) {
    ...
    if(ss < 0)
        image_blend= make_color_rgb(255, 255 + ss, 255 + ss);
    if(oo == 1)
        draw_sprite_ext(spr_asgore_wrapshock , 0, x, y, 2, 2, 0, 16777215, ii);
