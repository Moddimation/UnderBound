switch(argument0) {
    ...
    case 3004:
        ...
        global.msg[0]+= "  * Spare";
        if(global.mercy == 0) global.msg[0]+= "& \\W  * Flee";
        break;
    case 3003:
    ...
    case 1520:
        i= round(random(20));
        if(i == 0 || i == 1) global.msg[0]= "   * I\'m outta here.";
        if(i == 2) global.msg[0]= "   * I\'ve got better to do.";
        if(i > 3) global.msg[0]= "   * Escaped...";
        if(i == 3) global.msg[0]= "   * Don\'t slow me down.";
    ...
    case 1515:
        ...
        if(global.flag[202] >= 20) global.msg[0]= "* Determination./%%";
        if(room == 44)
    ...
    case 1061:
        ...
        global.msg[6]= "\\E0* Please remain here^2.&*\\E1 It\'s dangerous to&  explore by your/";
    ...
    case 1060:
        ...
        global.msg[2]= "* .../";
        global.msg[3]= "* I would like you to walk&  to the end of the room&  by your/";
    ...
    case 1056:
        ...
        if(global.choice == 1) global.msg[0]= "* You leave it alone./%%";
        break;
    case 1055:
        if(global.flag[56] == 5)
        ...
        if(global.flag[56] == 1) {
            global.msg[0]= "* How am I doing^1?&* By " + chr(ord('"'))+"I" + chr(ord('"'))+" I mean the piece&  of me I gave you.../";
            scr_itemcheck(16);
            scr_storagecheck(16);
            if(haveit == 0 && haveit2 == 0) {
    ...
    case 1052:
        ...
        if(global.choice == 1) {
            ...
            global.msg[4]= "\\E0I JUST FILL ALL&THE BOXES IN WITH&THE LETTER " + chr(ord('"'))+"Z" + chr(ord('"'))+".../";
    ...
    case 1037:
        if(global.flag[104] == 0) {
            ...
            global.msg[2]= " ";
        } else  global.msg[0]= "* It\'s just a bench./%%";
        break;
    case 1036:
        if(global.choice == 0) {
            if(doak == 0) {
    ...
    case 1035:
        if(global.flag[105] == 0) {
            ...
            global.msg[1]= "* (Will you take it?)& &         Take it     Leave it  \\C ";
            global.msg[2]= " ";
        } else  global.msg[0]= "* Nothing\'s here!!!/%%";
        break;
    case 1034:
        if(global.choice == 0) {
            if(doak == 0) {
            ...
            if(noroom == 1) global.msg[0]= "* (You\'re carrying too much.)/%%";
        }
        if(global.choice == 1) global.msg[0]= " %%";
        break;
    case 1033:
    ...
    case 1032:
        if(global.choice == 0) {
            ...
            if(noroom == 0) {
                ...
                if(global.flag[80] > 12) global.msg[0]= "* (You got a Punch Card.)/%%";
                global.flag[80]--;
            }
            if(noroom == 1) global.msg[0]= "* (You\'re carrying too much.)/%%";
        }
    ...
    case 1025:
        if(global.flag[107] != 1) {
            ...
            global.msg[1]= "* (Will you take it?)& &         Take it     Leave it  \\C ";
            global.msg[2]= " ";
        } else  global.msg[0]= "* (The artifact is gone.)/%%";
        break;
    case 1024:
        if(global.choice == 0) {
            if(doak == 0) {
    ...
    case 1017:
        if(global.flag[112] == 0) {
            ...
            global.msg[1]= "* (Will you take it?)& &         Take it     Leave it  \\C ";
            global.msg[2]= " ";
        } else  global.msg[0]= "* (It\'s an empty trashcan.)/%%";
        break;
    case 1016:
        if(global.choice == 0) {
            if(doak == 0) {
    ...
    case 1013:
        if(global.flag[114] == 0) {
            ...
            else  global.msg[0]= "* (Knife inside the box.)/";
            global.msg[1]= "* (Will you take it?)& &         Take it     Leave it  \\C ";
            global.msg[2]= " ";
        } else  global.msg[0]= "* Nothing\'s here!!!/%%";
        break;
    case 1012:
        if(global.choice == 0) {
            ...
            if(noroom == 0) {
                ...
                if(scr_murderlv() >= 16) global.msg[0]= "* (You got the Real Knife.)/%%";
                global.flag[114]= 1;
            }
            if(noroom == 1) global.msg[0]= "* (You\'re carrying too much.)/%%";
        }
    ...
    case 1010:
        if(global.choice == 0) {
            ...
            if(noroom == 0) {
                ...
                if(scr_murderlv() >= 16) global.msg[0]= "* (You got The Locket.)/%%";
                global.flag[115]= 1;
            }
            if(noroom == 1) global.msg[0]= "* (You\'re carrying too much.)/%%";
        }
    ...
    case 1007:
        ...
        if(noroom == 1) global.msg[0]= "* Drop something./%%";
        if(global.choice == 1) {
            global.msg[0]= "* Well then..^1.&* Tell your friends.../";
    ...
    case 1006:
        ...
        break;
    case 1005:
        global.msg[0]= "* " + chr(ord('"'))+"Press [Z] to read signs!" + chr(ord('"'))+"/%%";
        break;
    case 1004:
    ...
    case 1001:
        ...
        if(global.flag[33] == 0) {
            ...
            if(conversation == 9) global.msg[0]= "* Was that helpful?/%%";
            if(conversation == 12) {
                // obj_mainchara
                with(1570) uncan= 1;
    ...
    case 864:
        ...
        if(global.choice == 0) global.msg[0]= "* Nothing happened./%%";
        if(global.choice == 1) global.msg[0]= "%%";
    ...
    case 854:
        if(global.choice == 0) {
            ...
            global.msg[1]= "* " + chr(ord('"'))+"Why did the skeleton want&  a friend?" + chr(ord('"'))+"/";
            global.msg[2]= "* " + chr(ord('"'))+"Because she was feeling&  BONELY..." + chr(ord('"'))+"/";
    ...
    case 850:
        global.plot= 19.1;
        if(global.choice == 0) global.msg[0]= "* Sweet dreams./%%";
        else  {
            global.msg[0]= "\\E1* You\'d rather stay&  up and chat with&  me^1, then?/";
            if(global.flag[103] > 0) global.msg[0]= "* Up already^1, I see?/";
    ...
    case 847:
        ...
        if(global.choice == 0)
            ...
            global.msg[2]= "\\E0* It is called&  " + chr(ord('"'))+"72 Uses for Snails." + chr(ord('"'))+"/";
    ...
    case 834:
        if(global.choice == 0) {
            ...
            if(global.gold >= 80 && (global.flag[72] == 0 || global.flag[72] == 1)) {
                global.msg[0]= "* Here\'s your room key^1.&* Make sure to bundle up!/%%";
                obj_townnpc_innlady.conversation= 2;
                // obj_townnpc_innlady
                with(1451) jtext= 1;
        ...
        } else  global.msg[0]= "* Well^1, feel free to come&  back any time./%%";
        break;
    case 833:
    ...
    case 832:
        ...
        if(global.choice == 0 && !instance_exists(1035/* obj_starchecker */))
            instance_create(view_xview[0], view_yview[0], 1035/* obj_starchecker */);
        break;
    case 831:
    ...
    case 829:
        armor= "BEPIS.";
        if(global.armor == 4) armor= "GROSS BANDAGE";
    ...
    case 821:
        if(instance_exists(1025/* obj_papyrusparent */)) {
            ...
            global.msg[4]= "" + chr(ord('"'))+"HANG-OUT" + chr(ord('"'))+" LIKE&A PAIR OF VERY&COOL FRIENDS?/";
            if(global.flag[66] == 1)
    ...
    case 812:
        ...
        break;
    case 811:
        global.msg[0]= "* (This mailbox is labelled&  " + chr(ord('"'))+"PAPYRUS" + chr(ord('"'))+".)/";
        global.msg[1]= "* (Look inside?)& &         Yes         No\\C";
        global.msg[2]= " ";
        break;
    case 810:
        if(global.choice == 0) global.msg[0]= "* (It\'s empty.)/%%";
        else 
    ...
    case 809:
        ...
        global.msg[3]= " ";
        if(global.flag[67] == 1) global.msg[0]= "* .../%%";
        if(scr_murderlv() >= 7) {
    ...
    case 786:
        ...
        if(global.choice == 1) global.msg[0]= "\\E1* i\'ll tell you^1, then./";
    ...
    case 783:
        ...
        if(global.flag[84] == 5) global.msg[0]= "* Please leave./%%";
        if(global.flag[84] < 2) {
    ...
    case 782:
        if(global.flag[84] < 3) {
            if(global.choice == 0) {
                global.msg[0]= "* Huh^1?&* " + chr(ord('"'))+"SURFACE" + chr(ord('"'))+"^1?&* What do you mean?/";
                ...
                if(doak == 0) {
                    if(global.flag[84] == 0) global.flag[84]= 2;
                    doak= 1;
                }
            }
            if(global.choice == 1)
        ...
        if(doak == 0) {
            if(global.flag[85] == 0) {
                if(global.choice == 0) {
                    ...
                    obj_mainchara.lsprite= 1019;
                    obj_mainchara.usprite= 1017;
                } else  global.msg[0]= " %%";
            } else  {
                if(global.choice == 0) {
    ...
    case 764:
        ...
        noroom= 0;
        global.msg[0]= "* error/%%";
        if(global.flag[108] > 2) global.msg[0]= "* (The cooler is empty.)/%%";
    ...
    case 762:
        if(global.flag[355] == 0) {
            ...
            global.msg[2]= " ";
        } else  global.msg[0]= "* (You\'ve had enough of&  the dummy.)/%%";
        break;
    case 761:
        if(global.choice == 0) {
            if(global.lv == 1) {
    ...
    case 752:
        ...
        break;
    case 751:
        global.msg[0]= "* (This CD is labelled&  " + chr(ord('"'))+"Spooktunes." + chr(ord('"'))+")/";
    ...
    case 750:
        ...
        break;
    case 749:
        global.msg[0]= "* (This CD is labelled&  " + chr(ord('"'))+"Spookwave." + chr(ord('"'))+")/";
        global.msg[1]= "* (Play it?)& &         Play it     No\\C";
        global.msg[2]= " ";
        if(global.flag[94] == 2) {
            global.msg[0]= "* (This CD is labelled&  " + chr(ord('"'))+"Spookwave." + chr(ord('"'))+")/";
    ...
    case 748:
        ...
        break;
    case 747:
        global.msg[0]= "* (This CD is labelled&  " + chr(ord('"'))+"Ghouliday Music." + chr(ord('"'))+")/";
        global.msg[1]= "* (Play it?)& &         Play it     No\\C";
        global.msg[2]= " ";
        if(global.flag[94] == 3) {
            global.msg[0]= "* (This CD is labelled&  " + chr(ord('"'))+"Ghouliday Music." + chr(ord('"'))+")/";
    ...
    case 738:
        ...
        if(global.choice == 1) global.msg[0]= "* oh.........../%%";
        break;
    case 737:
        global.msg[0]= "* .../";
        global.msg[1]= "* Seven./";
    ...
    case 735:
        ...
        global.msg[8]= "* Undyne told me^1, um^1, " + chr(ord('"'))+"stay&  away from that human." + chr(ord('"'))+"/";
    ...
    case 729:
        ...
        if(instance_exists(1298/* obj_watercooler */)) {
            if(obj_watercooler.havewater == 1) {
                ...
                global.msg[1]= " ";
            } else  global.msg[0]= "* (She looks dry...)/%%";
        }
        break;
    case 728:
        global.msg[0]= " %%";
        if(global.choice == 0) {
            global.interact= 1;
            // obj_undynefall
            with(1295) event_user(1);
        }
        break;
    case 727:
        armor1= "BEPIS.";
        armor2= "BEPIS.";
        if(global.flag[75] == 4) armor1= "GROSS BANDAGE";
        ...
        if(global.flag[75] == global.flag[77] && global.flag[76] == 0) {
        ...
        if(global.flag[75] == global.flag[77] && global.flag[76] == 1) {
            global.msg[7]= "\\E0WELL^1, WORRY&NOT DEAR HUMAN!/";
        ...
        if(global.flag[75] != global.flag[77] && global.flag[76] == 1) {
            ...
            global.msg[10]= "\\E3" + chr(ord('"'))+"I AM NOT&WEARING A&" + armor1 + "." + chr(ord('"'))+"/";
            global.msg[11]= "\\E0IT WAS REALLY&A SECRET CODE!/";
            global.msg[12]= "\\E3YOU REALLY&MEANT.../";
            global.msg[13]= "\\E0" + chr(ord('"'))+"I ACTUALLY AM&WEARING&A " + armor1 + "!" + chr(ord('"'))+"/";
    ...
    case 724:
        ...
        global.msg[2]= "* We call this state&  " + chr(ord('"'))+"Fallen Down." + chr(ord('"'))+"/";
    ...
    case 716:
        ...
        global.msg[1]= "* A certain type of monster^1,&  the " + chr(ord('"'))+"boss" + chr(ord('"'))+" monster./";
    ...
    case 714:
        ...
        if(global.choice == 1) global.msg[0]= "* (You decide not to.)/%%";
        break;
    case 713:
        global.msg[0]= "* (All these books are labelled&  Human History.)&         Read one    Do not\\C";
        global.msg[1]= " ";
    ...
    case 706:
        ...
        global.msg[1]= "Little white..^2.\\E1 &" + chr(ord('"'))+"friendliness&pellets." + chr(ord('"'))+"/";
    ...
    case 690:
        ...
        global.msg[14]= "\\E9* A lot better about&  my/";
    ...
    case 669:
        if(global.choice == 0) {
            ...
            global.msg[7]= "\\M1* We\'re going to&  become " + chr(ord('"'))+"friends." + chr(ord('"'))+"/";
    ...
    case 666:
        global.msg[0]= " %%";
        if(global.choice == 0) obj_undynedate_inside.con= 60;
        if(global.choice == 1) {
            global.msg[0]= " %%";
            global.msg[1]= " %%";
        }
    ...
    case 643:
        if(global.choice == 0) {
            ...
            global.msg[3]= "\\E0* She figured out all&  the specs her../";
    ...
    case 640:
        ...
        global.msg[2]= "\\M4* " + chr(ord('"'))+"A DOG EXISTS SOMEWHERE." + chr(ord('"'))+"/";
    ...
    case 622:
        ...
        global.msg[2]= "\\M5* WHAT COULD BE INSIDE^1?&* WELL^1, NO TIME LIKE THE&  " + chr(ord('"'))+"PRESENT" + chr(ord('"'))+" TO FIND OUT!/";
        global.msg[3]= "\\M2* (REPORT THIS ONE?)& &         Report      Look More\\C";
        global.msg[4]= " ";
        break;
    case 621:
    ...
    case 598:
        global.flag[409]= 1;
        global.msg[0]= "* (It seems to have already&  rejected it..)/%%";
        break;
    case 597:
    ...
    case 596:
        ...
        if(global.choice == 1) global.msg[0]= "* You rejected the request./%%";
        break;
    case 595:
        global.msg[0]= "* \\YMETTATON has sent you an&  invitation to " + chr(ord('"'))+"Die." + chr(ord('"'))+"\\W /";
        global.msg[1]= "* RSVP?& &         Respond     Ignore\\C";
        global.msg[2]= " ";
        break;
    case 594:
        if(global.choice == 0) global.msg[0]= "* Bepis valley Granola Bars/%%";
        if(global.choice == 1) global.msg[0]= "* Bepis valley Granola Bars/%%";
        break;
    case 593:
    ...
    case 585:
        if(global.choice == 0) {
            if(room == 140 || room == 125) global.flag[459]= 1;
            if(room == 70) global.flag[459]= 2;
        }
        if(global.choice == 1) {
    ...
    case 584:
        if(global.flag[490] == 0) {
            ...
            global.msg[1]= "* (Press it?)& &         Yes         No\\C";
            global.msg[2]= " ";
        } else  global.msg[0]= "* (The switch doesn\'t do&  anything.)/%%";
        break;
    case 583:
        global.msg[0]= " %%";
        if(global.choice == 0) {
    ...
    case 575:
        ...
        global.msg[8]= "\\E2* .../";
        global.msg[9]= "\\E5* " + chr(ord('"'))+"Frisk?" + chr(ord('"'))+"/";
    ...
    case 573:
        ...
        global.msg[6]= "\\E3* I\'ll stop being&  " + chr(ord('"'))+"my" + chr(ord('"'))+"/";
    ...
    case 566:
        ...
        global.msg[3]= "\\E0* " + chr(ord('"'))+"Would you like a&  cup of tea?" + chr(ord('"'))+"/";
        global.msg[4]= "\\E2* .../";
    ...
    case 563:
        global.msg[0]= " %%";
        if(global.choice == 0) obj_underground_exit.con= 2;
        if(global.choice == 1) obj_underground_exit.con= 10;
        break;
    case 562:
        ...
        scr_sansface(13, 1);
        global.msg[14]= "\\E1* we call that&  " + chr(ord('"'))+"the sun^1," + chr(ord('"'))+" my friend./";
        scr_papface(15, 0);
    ...
    case 554:
        if(global.choice == 0) {
            ...
            global.msg[13]= "* If you want to know&  " + chr(ord('"'))+"the truth." + chr(ord('"'))+"/";
    ...
    case 550:
        ...
        ini_close();
        if(global.choice == 0) {
            if(bs == 1) global.flag[46]= 1;
            if(bs == 2) global.flag[46]= 0;
        ...
        if(global.choice == 1) {
            if(bs == 1) global.flag[46]= 0;
            if(bs == 2) global.flag[46]= 1;
            ...
            else  ini_write_real("Toriel", "Bscotch", 1);
            ini_close();
        }
        break;
    case 549:
    ...
    case 525:
        if(global.choice == 0) {
            ...
            global.msg[2]= "* (Seems like the dog needs&  to " + chr(ord('"'))+"patch" + chr(ord('"'))+" the fabric.)/";
    ...
    case 524:
        ...
        if(global.flag[262] == 0) {
            ...
            global.msg[1]= "* Got my " + chr(ord('"'))+"Sea Tea" + chr(ord('"'))+" ?& &         Yes         No\\C";
            global.msg[2]= " ";
            if(global.flag[7] == 1)
                global.msg[0]= "* Room service never came ^1.&* (Sigh ...)/%%";
        } else  {
            global.msg[0]= "* Thanks a million ./%%";
            if(global.flag[7] == 1) global.msg[0]= "* (No response.)/%%";
        }
        break;
    case 523:
        if(global.choice == 0) {
            ...
            } else  global.msg[0]= "* ..^1.&* No you don\'t ./%%";
        } else  global.msg[0]= "* Then ...!?/%%";
        break;
    case 522:
        global.msg[0]= "* (Knock knock)./";
        if(global.flag[263] == 0) {
            global.msg[0]= "* Oooooaaah ^1!&* Room service !/";
            global.msg[1]= "* Got my " + chr(ord('"'))+"Cinnamon Bun" + chr(ord('"'))+" ?& &         Yes         No\\C";
            global.msg[2]= " ";
            if(global.flag[7] == 1)
                global.msg[0]= "* Room service never came ^1.&* (Sigh ...)/%%";
        } else  {
    ...
    case 519:
        if(global.choice == 0) {
            ...
            type= 0;
            scr_itemcheck(38);
            if(haveit == 1 && global.flag[264] == 0) type= 1;
            scr_itemcheck(39);
            if(haveit == 1) type= 2;
            scr_itemcheck(28);
            if(haveit == 1) type= 3;
    ...
    case 517:
        if(global.choice == 0) {
            if(global.gold >= 200) {
                ...
                if(global.flag[267] < 1) global.flag[267]= 1;
                obj_hotelreceptionist.con= 1;
            } else  global.msg[0]= "* ... that\'s not enough money./%%";
        } else 
    ...
    case 514:
        ...
        break;
    case 513:
        if(global.choice == 0) global.msg[0]= "Exactly./%%";
        else  global.msg[0]= "Then what are you looking for?/%%";
        break;
    case 512:
    ...
    case 202:
        ...
        if(global.flag[501] == 1) {
            if(global.flag[505] == 0) global.msg[0]= "\\W   * Undyne        ";
            else  global.msg[0]= "\\W   \\Y* (Saved)      \\W ";
            if(global.flag[506] == 0)
                global.msg[0]+= "* Alphys \\W &";
            else  global.msg[0]+= "\\Y* (Saved)\\W &";
        ...
        if(global.flag[501] > 1) {
            if(global.flag[501] == 2) global.msg[0]= "   * Someone else";
            if(global.flag[501] == 3) global.msg[0]= "   * Asriel Dreemurr";
            global.choices[0]= 1;
            global.choices[1]= 0;
            global.choices[2]= 0;
            global.choices[3]= 0;
    ...
    case 30:
        ...
        global.msg[1]= "\\F1 %";
        global.msg[2]= "* This is TORIEL./";
        global.msg[3]= "\\E8* Huh^2?&* Did you just call&  me... " + chr(ord('"'))+"Mom" + chr(ord('"'))+"?/";
        global.msg[4]= "\\E1* Well...&* I suppose.../";
        global.msg[5]= "* Would that make you&  happy?/";
        global.msg[6]= "* To call me..^2.&* " + chr(ord('"'))+"Mother?" + chr(ord('"'))+"/";
    ...
    case 23:
        ...
        if(global.flag[41] == 2) {
            ...
            global.msg[5]= "* Click.../%%";
            if(global.flag[42] == 1) {
                global.msg[3]= "\\E8* And after you said you&  want to call&  me " + chr(ord('"'))+"mother..." + chr(ord('"'))+"/";
                global.msg[4]= "\\E0* You are an...^2 &  \\E1... " + chr(ord('"'))+"interesting" + chr(ord('"'))+"&  child./";
                global.msg[5]= "\\TS \\F0 \\T0 %";
                global.msg[6]= "* Click.../%%";
            }
        }
    ...
    case 17:
        ...
        break;
    case 16:
        if(global.flag[7] == 0) scr_papcall();
        else 
