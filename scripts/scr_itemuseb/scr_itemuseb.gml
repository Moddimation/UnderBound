function scr_itemuseb(argument0, argument1) {
	switch(argument1) {
	    ...
	    case 206:
	        if(instance_exists(obj_dogeparent )) {
	            ...
	            if(instance_exists(obj_mandog ) || instance_exists(obj_womandog )) {
	                if(scr_monstersum() == 1) {
	                    script_execute(scr_writetext , 0, "* You threw the stick^1.&* But nothing happened./%", 0, 0);
	                    obj_dogeparent.mercymod= -9999;
	                } else  script_execute(scr_writetext , 0, "* You threw the stick and&  the dogs ran to get it^1.&* You played fetch for a while./%", 0, 0);
	            } else  {
	                if(instance_exists(obj_greatdog )) obj_dogeparent.mercymod= 250;
	                script_execute(scr_writetext , 0, "* You threw the stick and&  the dog ran to get it^1.&* You played fetch for a while./%", 0, 0);
	            }
	            if(instance_exists(obj_endogeny )) obj_endogeny.mercymod= 999999;
	        } else  {
	            if(instance_exists(obj_papyrusboss ) || instance_exists(obj_wizard ) || instance_exists(obj_mettatonex )) {
	                if(instance_exists(obj_papyrusboss )) script_execute(scr_writetext , 0, "* You throw the stick.&* Papyrus brings it back&  in his mouth./%", 0, 0);
	                if(instance_exists(obj_wizard )) {
	                    script_execute(scr_writetext , 0, "* You raise the stick.&* Madjick mistakes it for&  a magic wand./%", 0, 0);
	                ...
	                if(instance_exists(obj_mettatonex )) {
	                    ...
	                    script_execute(scr_writetext , 0, "* You throw the stick.&* Mettaton catches it in his&  mouth and winks./%", 0, 0);
	                }
	            } else  script_execute(scr_writetext , 0, "* You threw the stick away^1.&* Then picked it back up./%", 0, 0);
	        }
	        break;
	    case 205:
	    ...
	    case 62:
	        ...
	        if(spec_p == 0) script_execute(scr_writetext , 0, "* You ate the Butterscotch Pie.&* Your HP was maxed out./%", 0, 0);
	        if(spec_p == 1) script_execute(scr_writetext , 0, "* You ate the Butterscotch Pie.&* Your HP was maxed out./", 0, 0);
	        script_execute(scr_itemshift , argument0, 0);
	        break;
	    case 61:
	    ...
	    case 37:
	        ...
	        if(global.inbattle == 1) {
	            ...
	            } else  nood= instance_create(0, 0, obj_instantnoodleitem );
	        }
	        script_execute(scr_itemshift , argument0, 0);
	        break;
	    case 36:
	    ...
	    case 34:
	        ...
	        if(global.seriousbattle == 0) {
	            ...
	            if(global.seriousbattle == 1) grt.sound2= 155;
	            grt.alarm[1]= 10;
	        } else  grt= instance_create(0, 0, obj_foodsound );
	        script_execute(scr_recoitem , 21);
	        script_execute(scr_itemshift , argument0, 0);
	        break;
	    case 33:
	    ...
	    case 10:
	        ...
	        if(spec_p == 0) script_execute(scr_writetext , 0, "* You ate the Snail Pie.&* Your HP was maxed out./%", 0, 0);
	        if(spec_p == 1) script_execute(scr_writetext , 0, "* You ate the Snail Pie.&* Your HP was maxed out./", 0, 0);
	        script_execute(scr_itemshift , argument0, 0);
	        break;
	    case 9:
	        scr_armoreq(argument0, argument1);
	        ...
	        if(global.flag[37] == 1) scr_writetext(1508, "x", 0, 0);
	            ...
	            if(global.plot < 19.9) {
	                if(global.plot > 18 && room == 33) {
	                    ...
	                    snd_play(snd_phone );
	                    if(global.flag[41] == 1) script_execute(scr_phoneshift , argument0, 0);
	    ...
	    case 3:
	        ...
	        snd_play(snd_phone );
	        if(global.flag[7] == 0) script_execute(scr_writetext , 1506, "x", 0, 0);
	        if(global.flag[7] == 1) script_execute(scr_writetext , 1515, "x", 0, 0);
	        break;
	    case 2:
	        scr_phone_moveup(argument0, argument1);
	    ...
	    case 1:
	        if(room != 103) {
	            ...
	            ii.spec= 1;
	            ii.boxtype= 0;
	        } else  script_execute(scr_writetext , 1520, "x", 0, 0);
	        break;
	    case 0:
	        if(room != 103) {
	            snd_play(snd_dimbox );
